    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di SI Data Pegawai Dinas Pendidikan Kota Tanjungbalai</strong>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['alamat'] ?></td>
                                    <td><?= $data['jabatan'] ?></td>
                                    <td><img src= "img/<?= $data['nama_file']?>" style='height:70px; width:70px' class='img-circle'></td>
                                </tr>
